...
public class SubtractionOp extends Operator {
    ...
    public Value operate(Expression expression1, Expression expression2, SymTab symTab) throws InterpreterException {
        ...
        throw new InterpreterException("Expected Int types for subtraction operator. Instead found: "
                + leftValue.get().getType() + ", " + rightValue.get().getType());
    }

    @Override
    public String getType() {
        return "SubtractionOpType";
    }
}
